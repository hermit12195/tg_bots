...
async def db_conn():
    ...
    try:
        ...
        print(f"Error during connection to DB - {error}")
...
async def client_check(tg_id):
    ...
    try:
        ...
        print(f"Error with getting user list - {error}")
...
async def create_client(tg_id, name, phone):
    ...
    try:
        ...
        print(f"Error during client creation - {error}")
...
async def create_order(tg_id, social_network, niche, expectation, service_type):
    ...
    try:
        ...
        print(f"Error during order creation - {error}")
